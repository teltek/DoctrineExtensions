 ...
 */
class MaterializedPathODMMongoDBRepositoryNoEndsWithSeparatorTest extends BaseTestCaseMongoODM
{
    const CATEGORY = "Tree\\Fixture\\Document\\CategoryNoEndsWithSeparator";
